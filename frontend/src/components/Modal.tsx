	...
	return (
		...
		>
			<div className="modalContent">
				...
				{product !== undefined ? <Items id={product.id} isCarousel={false} img={product.image_link} name={product.name} description={product.description} price={product.price} onClick={() => void(0)} isModal={false} />	: null}
			</div>
		</div>
	);
}
